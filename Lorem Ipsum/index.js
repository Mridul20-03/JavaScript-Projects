...
//default behaviour of form is to submit to server
//so it will not be seen here
form.addEventListener('submit',function(e){
    //console.log("hello");
    //we need to prevent thje default behaviour
    e.preventDefault();

    //although in form our datatupe is number but when we do this it return string
   ...
   if(isNaN(value) || value<=0 || value>9)
    {
        ...
        tempText = tempText.map(function(i){
            return `<p class="result">${i} </p>`;
        }).join("");
